...
function Menu({ View }) {
  return (
    <div class="menu">
      ...
      <p class="menu__mail">martorana.emily38@gmail.com</p>
      <p class={'menu__scroll' + (View !== 'Home' ? ' menu__scroll--isActive' : '')}>— Defiler pour explorer</p>
    
     <a href="#Home"> 
     <svg  class={"menu__arrow" + (View !== 'Home' ? ' menu__arrow--isActive' : '')} width="50" height="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
